...
class AttU_Net(nn.Module):
    def __init__(self,img_ch=3,output_ch=3):
        ...
        self.Conv1_2 = conv_block(ch_in=img_ch,ch_out=64)
        ...
        self.Conv5_2 = conv_block(ch_in=512,ch_out=1024)
    ...
    def forward(self,face, hair):
        ...
        hair1 = self.Conv1_2(hair)

        hair2 = self.Maxpool(hair1)
        hair2 = self.Conv2_2(hair2)
        
        hair3 = self.Maxpool(hair2)
        hair3 = self.Conv3_2(hair3)

        hair4 = self.Maxpool(hair3)
        hair4 = self.Conv4_2(hair4)

        hair5 = self.Maxpool(hair4)
        hair5 = self.Conv5_2(hair5)
